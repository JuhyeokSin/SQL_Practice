...
a single Projects table that has five columns as the following:
...
he wants you to create another table by removing the internal_id and team_size columns
from the existing Projects table. Return it sorted by internal_id in ascending order.
*/
...
FROM Projects
ORDER BY internal_id ASC;
>>>>>>> 9b4e3a0d779bd11626585aad53ea4bfa06ac3e66
