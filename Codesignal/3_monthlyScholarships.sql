...
Information about the scholarships is stored in the table scholarships, which has
the structure:
...
The table should have the same columns as the initial table, but the scholarship
column should contain the amount of the student's monthly scholarship payout.
